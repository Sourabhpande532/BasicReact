...
👋@heading@👋
 ...
 -By the term Library it mean what's ? 
  ...
  😍😎🥰Best thing about react is that it does not enforce you to do anything it can use any library & it is build by open sourch powered by open source so to get all this functinality we need something know as 😱"BUNDLERS"-⤵️
...
-❕Defference=> most BUNDLERS Do almost same Job.
...
@identyfire[🙊(explaination about react and props)] 👇
